...
class QRShowViewController: UIViewController {
    ...
    func addQrCodeToImage(){
        ...
        do {
            let tempImage = resizeImage(image: (currentUserProfile.avatar?.toImage())!, targetSize: CGSize(width: 10.0, height: 10.0))
            
            currentUserProfile.avatar=tempImage.toString()
